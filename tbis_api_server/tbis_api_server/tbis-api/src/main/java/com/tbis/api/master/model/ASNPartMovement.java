...
public class ASNPartMovement {	
	...
	private int exclusivePartCount;
	...
	public int getExclusivePartCount() {
		return exclusivePartCount;
	}
	public void setExclusivePartCount(int exclusivePartCount) {
		this.exclusivePartCount = exclusivePartCount;
	}
